...
Результат оказался положительный, поэтому появилась задача на доработку макета для масштабирования на всю сеть стран и городов. На данный момент находится в работе.
